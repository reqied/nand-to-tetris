...
load Memory20K.hdl,
output-file Memory20K.out,
compare-to Memory20K.cmp,
...
set in -1,				// Set RAM[4000] = -1 (screen)
set load 1,
set address %X4000,
tick,
output;
...
set load 0,
set address %X4000,     // RAM[4000] holds value (screen)
eval,
output;

set in -1,				// Set RAM[7000] = -1 (extended memory)
set load 1,
set address %X7000,
tick,
output;
...
set load 0,
set address %X7000,     // RAM[7000] holds value (screen)
eval,
output;

set in -1,				// Set RAM[7fff] = -1 (extended memory)
set load 1,
set address %X7fff,
tick,
output;
...
set load 0,
set address %X7fff,     // RAM[6fff] holds value (screen)
eval,
output;


set in 42, set load 1, set address 1, tick, tock, output;
set in 42, set load 1, set address %X4001, tick, tock, output; // screen
set in 42, set load 1, set address %X5001, tick, tock, output; // screen2
set in 42, set load 1, set address %X7001, tick, tock, output; // extended ram4K
set in 1, set load 1, set address 1, tick, tock, output; // 1
set load 0, 
set address %X1, tick, tock, output; // 1
set address %X4001, tick, tock, output; // 42
set address %X5001, tick, tock, output; // 42
set address %X7001, tick, tock, output; // 42
set in 2, set load 1, set address %X4001, tick, tock, output; // 2
set load 0, 
set address 1, tick, tock, output; // 1
set address %X4001, tick, tock, output; // 2
set address %X5001, tick, tock, output; // 42
set address %X7001, tick, tock, output; // 42
set in 3, set load 1, set address %X5001, tick, tock, output; // 3
set load 0, 
set address 1, tick, tock, output; // 1
set address %X4001, tick, tock, output; // 2
set address %X5001, tick, tock, output; // 3
set address %X7001, tick, tock, output; // 42
set in 4, set load 1, set address %X7001, tick, tock, output; // 4
set load 0, 
set address 1, tick, tock, output; // 1
set address %X4001, tick, tock, output; // 2
set address %X5001, tick, tock, output; // 3
set address %X7001, tick, tock, output; // 4
set in 5, set load 1, set address %X6001, tick, tock, output; // 0 = VOID
set load 0, 
set address 1, tick, tock, output; // 1
set address %X4001, tick, tock, output; // 2
set address %X5001, tick, tock, output; // 3
